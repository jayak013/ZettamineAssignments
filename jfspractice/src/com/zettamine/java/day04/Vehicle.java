...
public class Vehicle implements Loan,Insurance {
	...
	public double issueLoan() {
		if(vehicleType.equals("4 wheeler")) return price*0.8;
		else if(vehicleType.equals("3 wheeler")) return price*0.75;
		else  return price*0.5;
	}
	
	@Override
	public double takeInsurance() {
		if(price<=150000) return 3500;
		else if(price>150000 && price<=300000) return 4000;
		else return 5000;
	}
